...
const Navbar = () => {
  ...
  return (
    <header className="text-white/70 md:pt-6 md:bg-gradient-to-b from-black to-[#381a5f] ">
          ...
          <li>
            <a href="#contact" className="group">
              ...
              <div className="relative">
                <div className="absolute w-2/3 h-1 transition-all duration-300 ease-out bg-orange-500 rounded-full group-hover:w-full"></div>
